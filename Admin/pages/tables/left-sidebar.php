    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="users.php"><i class="fa fa-circle-o"></i> Lista korisnika</a></li>
          <li><a href="add_user.php"><i class="fa fa-circle-o"></i> Dodaj korisnika</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="catlist.php"><i class="fa fa-circle-o"></i> Lista proizvođača</a></li>
          <li><a href="catadd.php"><i class="fa fa-circle-o"></i> Dodaj proizvođača</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="brandlist.php"><i class="fa fa-circle-o"></i> Lista kategorija</a></li>
          <li><a href="brandadd.php"><i class="fa fa-circle-o"></i> Dodaj</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="productlist.php"><i class="fa fa-circle-o"></i> Lista telefona i opreme</a></li>
          <li><a href="productadd.php"><i class="fa fa-circle-o"></i> Dodaj</a></li>
        </ul>
      </li>
