 ...
 * Ã‚Â©2008-2013 SpryMedia Ltd - datatables.net/license
 */
...
/** @lends <global> */ (function (window, document, $, undefined) {
  (function (factory) {
    ...
    /** @lends <global> */ function ($) {
      ...
      var _re_new_lines = /[\r\n]/g;
      var _re_html = /<.*?>/g;
      var _re_formatted_numeric = /[',$Ã‚Â£Ã¢Â‚Â¬Ã‚Â¥%]/g;
      ...
      DataTable = function (options) {
        ...
        this.each(function () {
          ...
          if (rowOne.length) {
            ...
            $.each(_fnGetRowElements(oSettings, rowOne[0]).cells, function (
              i,
              cell
            ) {
      ...
      var __details_events = function (settings) {
        ...
        if (_pluck(settings.aoData, "_details").length > 0) {
          ...
          table.on("column-visibility.DT_details", function (
            e,
            settings,
            idx,
            vis
      ...
      _api_registerPlural("columns().data()", "column().data()", function () {
        return this.iterator("column-rows", function (
          settings,
          column,
          i,
          j,
      ...
      _api_register(["cells().invalidate()", "cell().invalidate()"], function (
        src
      ) {
        var selector = this.selector;
      ...
      _api_register(["columns().search()", "column().search()"], function (
        input,
        regex,
        smart,
        caseInsen
      ...
      DataTable.defaults = {
        ...
        oLanguage: {
           ...
           *    } );
           */
          sInfo: "Prikaz _START_ to _END_ of _TOTAL_ unosa",
           ...
           *    } );
           */
          sInfoEmpty: "Prikaz 0 to 0 of 0 unosa",
      ...
      $.extend(true, DataTable.ext.renderer, {
        header: {
          _: function (settings, cell, column, idx, classes) {
            ...
            $(settings.nTable).on("order.dt", function (
              e,
              settings,
              sorting,
              columns
