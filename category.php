         ...
         if ($productbycat) {
            ...
            <div class="grid_1_of_4 images_1_of_4 hvr-float">
                <a
                    ...
                    <img id="img01" src="admin/pages/tables/<?php echo $result['image']; ?>"
                        alt="" /></a>

                <h1 class="product-name arial w-600"><?php echo $result['productName']; ?>
                </h1>
                ...
                <a href="preview.php?proid=<?php echo $result['productId']; ?>"
                    class="details"><input style="font-size:13px;" class="btn btn-primary2" type="button"
